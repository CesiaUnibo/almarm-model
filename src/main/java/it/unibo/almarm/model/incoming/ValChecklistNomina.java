...
public class ValChecklistNomina implements java.io.Serializable {

	private static final long serialVersionUID = 1L;

	private Long id;
	private ElChecklistNomina elementoChecklist;
	...
	public ElChecklistNomina getElementoChecklist() {
		return elementoChecklist;
	}

	public void setElementoChecklist(ElChecklistNomina elementoChecklist) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof ValChecklistNomina))
			return false;
		ValChecklistNomina other = (ValChecklistNomina) obj;
