...
import it.unibo.almarm.model.staff.IncomingStaffChecklistView;

public class IncomingStaffChecklistElement implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof IncomingStaffChecklistElement))
			return false;
		IncomingStaffChecklistElement other = (IncomingStaffChecklistElement) obj;
