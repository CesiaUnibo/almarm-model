...
public class StudenteIncomingAllegato implements java.io.Serializable {
	...
	public void setDaNotificare(boolean daNotificare) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof StudenteIncomingAllegato))
			return false;
		StudenteIncomingAllegato other = (StudenteIncomingAllegato) obj;
		if (idAllegato == null) {
