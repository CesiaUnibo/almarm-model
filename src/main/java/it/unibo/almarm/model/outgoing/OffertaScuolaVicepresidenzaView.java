...
public class OffertaScuolaVicepresidenzaView implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof OffertaScuolaVicepresidenzaView))
			return false;
		OffertaScuolaVicepresidenzaView other = (OffertaScuolaVicepresidenzaView) obj;
		if (id == null) {
			if (other.id != null)
				return false;
