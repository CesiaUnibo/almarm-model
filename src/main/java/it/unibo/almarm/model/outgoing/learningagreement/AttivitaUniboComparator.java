...
public class AttivitaUniboComparator implements Comparator<AttivitaUnibo>, java.io.Serializable
{
	...
	public int compare(AttivitaUnibo o1, AttivitaUnibo o2) {
		...
		{
			if (o1.getCfu() != null && o2.getCfu() != null)
				return o1.getCfu().compareTo(o2.getCfu());
			if (o1.getSsd() != null && o2.getSsd() != null)
				return o1.getSsd().compareTo(o2.getSsd());
			return 0;
		}
