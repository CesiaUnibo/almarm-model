...
public class AccordoOperativoAteneoView implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof AccordoOperativoAteneoView))
			return false;
		AccordoOperativoAteneoView other = (AccordoOperativoAteneoView) obj;
		if (id == null) {
			if (other.id != null)
				return false;
