...
public class AccordoIstituzionaleAteneoView implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof AccordoIstituzionaleAteneoView))
			return false;
		AccordoIstituzionaleAteneoView other = (AccordoIstituzionaleAteneoView) obj;
		if (id == null) {
			if (other.id != null)
				return false;
