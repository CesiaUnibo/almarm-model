...
public class EntitaEsternaNazionePerRicercaView implements java.io.Serializable {
	...
	public Character getFlagAteneo() {
		return flagAteneo;
	}

	public void setFlagAteneo(Character flagAteneo) {
		this.flagAteneo = flagAteneo;
	}
	
	public boolean isAteneo() {
		return Common.CH_S.equals(getFlagAteneo());
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof EntitaEsternaNazionePerRicercaView))
			return false;
		EntitaEsternaNazionePerRicercaView other = (EntitaEsternaNazionePerRicercaView) obj;
		if (id == null) {
			if (other.id != null)
				return false;
