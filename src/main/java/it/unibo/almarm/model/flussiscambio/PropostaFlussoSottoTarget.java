...
public class PropostaFlussoSottoTarget implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof FlussoAccordoSottoTarget))
			return false;
		PropostaFlussoSottoTarget other = (PropostaFlussoSottoTarget) obj;
		if (ammesso == null) {
			if (other.ammesso != null)
				return false;
		} else if (!ammesso.equals(other.ammesso))
			return false;
		return true;
	}	
}
